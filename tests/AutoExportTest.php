...
class AutoExportTest extends WP_UnitTestCase
{
    ...
    public function testEnabledFalseOnNonLocalHome(): void
    {
    ...
    public function testEnabledTrueOnLoopbackHome(): void
    {
    ...
    public function testOnSaveDoesNotArmUnderWpCli(): void
    {
    ...
    public function testOnDeleteDoesNotArmUnderWpCli(): void
    {
    ...
    public function testWorkerBailsAndWritesNothingWhenLockHeld(): void
    {
    ...
    public function testWorkerRunsExportClearsPendingReleasesLock(): void
    {
    ...
    public function testWorkerLoopsAgainAndTrailingPassExportsFreshContent(): void
    {
        global $wpdb;
        ...
        $file = $this->export_dir.'/page-'.$id.'/fr_FR.html';
        ...
        $passes = 0;
        add_filter('polyglot_exportable_statuses', static function (array $statuses) use (&$passes, $wpdb, $id): array {
            if (0 === $passes++) {
    ...
    public function testManualExportDrainsQueuedSaveWhenLocal(): void
    {
        add_filter('home_url', static fn () => 'http://127.0.0.1:9172');
        self::factory()->post->create([
            'post_type' => 'page',
    ...
    public function testImportDrainsQueuedSaveWhenLocal(): void
    {
        add_filter('home_url', static fn () => 'http://127.0.0.1:9172');
        self::factory()->post->create([
            'post_type' => 'page',
    ...
    public function testCommandDoesNotDrainWhenDisabled(): void
    {
